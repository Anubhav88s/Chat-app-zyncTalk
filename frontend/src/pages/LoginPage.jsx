        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <h1 className="text-3xl font-bold mt-2 text-base-content/90 tracking-tight">Welcome Back</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button type="submit" className="btn btn-primary w-full rounded-2xl btn-lg group-hover:shadow-lg transition-transform hover:scale-[1.01] active:scale-[0.99]" disabled={isLoggingIn}>
              {isLoggingIn ? (
                <>
          ...
          <div className="text-center">
            <p className="text-base-content/60">
              ...
              <Link to="/signup" className="link link-primary hover:underline transition-all font-medium">
                Create account
              </Link>
            </p>
          </div>
